...
# Achievements      
if int(now) >= 62:
    print("\nAchievement Unlocked: Better Than The Creator")
    print("GG")

if int(now) <= 5:
    print("\nAchievement Unlocked: Good At Being Bad")
    print("At least your good at something!")

if int(now) >= 100:
    print("\nAchievement Unlocked: Masterful")
    print("More than 100 seconds! Nice Job!")
